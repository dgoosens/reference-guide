...
2. `sendWithMetadata` - Does the same as `send,` allows for sending additional [Meta data](../tutorial/lesson-4-method-invocation-and-metadata.md#metadata).
...
4. `convertAndSendWithMetadata` - Does the same as `convertAndSend,` allow for sending additional [Meta data](../tutorial/lesson-4-method-invocation-and-metadata.md#metadata).
